...
# Based on work by : Matt Hawkins + Texy
#
# Date   : 27/03/2013
#
...
class AndyPi_LCD:
  ...
  # import wiringpi class (need to install by ???
  import wiringpi
  #  import GPIO class (need to install sudo pip install rpi-gpio
  ...
  def lcd_init(self):
    ...
    self.lcd_byte(0x06,self.LCD_CMD)  # shift cursor right
